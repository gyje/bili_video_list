...
pages_num=int(input("空间视频页数量"))+1
space_aid=input("空间id")
format = '%Y-%m-%d %H:%M:%S'
for i in range(1,pages_num):
	url="http://space.bilibili.com/ajax/member/getSubmitVideos?mid="+space_url+"&pagesize=30&tid=0&page="+str(i)+"&keyword=&order=senddate&_=1493786538801"
